...
export default function Login() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-gradient-to-bl from-brand-50 via-white to-accent-50 dark:from-[#0d2235] dark:via-[#0f1115] dark:to-[#221532] p-4">
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        <div className="card !p-8 shadow-soft">
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            {t('auth.noAccount')}{' '}
            <Link href="/register" className="font-extrabold text-brand-600 hover:text-brand-700">
