  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 animate-fade-in">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Link href="/dashboard/generator" className="btn-primary">{copy.create}</Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="card py-16 text-center">
          ...
          <Link href="/dashboard/generator" className="btn-primary mt-5">{copy.create}</Link>
        </div>
      ) : (
            ...
            return (
              <article key={draft.draft_id} className="card flex min-h-48 flex-col">
                ...
                <div className="mt-auto pt-6">
                  ...
                  <Link href={`/dashboard/generator?draft=${encodeURIComponent(draft.draft_id)}`} className="btn-outline w-full">
                    {copy.open}
                  </Link>
                </div>
              </article>
