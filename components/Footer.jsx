        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li><Link href="/" className="transition-colors hover:text-brand-400">{t('nav.home')}</Link></li>
              <li><Link href="/login" className="transition-colors hover:text-brand-400">{t('nav.login')}</Link></li>
              <li><Link href="/register" className="transition-colors hover:text-brand-400">{t('footer.createAccount')}</Link></li>
              <li><Link href="/dashboard/generator" className="transition-colors hover:text-brand-400">{t('footer.campaignGenerator')}</Link></li>
            </ul>
          </div>
